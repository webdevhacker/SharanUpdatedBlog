...
<head>
  ...
  <title>New Sign-in Detected — TechBlog</title>
</head>
    ...
    <tr>
      <td align="center">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.10);">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#10B981 0%,#059669 100%);padding:44px 40px;text-align:center;">
              ...
              <p style="margin:6px 0 0;color:rgba(255,255,255,0.85);font-size:14px;letter-spacing:1px;text-transform:uppercase;">Security Alert</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:44px 40px 32px;">
              ...
              <h2 style="margin:0 0 20px;font-size:18px;font-weight:600;color:#059669;">New Sign-in Detected</h2>

              <p style="margin:0 0 24px;font-size:15px;line-height:1.7;color:#475569;">
                A new sign-in to your TechBlog account was detected. Here are the details:
              </p>
              ...
              <div style="background:#f0fdf4;border:1px solid #86efac;border-radius:10px;padding:16px 20px;margin:0 0 20px;">
                <p style="margin:0;font-size:14px;color:#166534;font-weight:600;">✅ If this was you</p>
              ...
              <div style="background:#fef2f2;border:1px solid #fecaca;border-radius:10px;padding:16px 20px;margin:0 0 28px;">
                ...
                <p style="margin:6px 0 0;font-size:14px;color:#b91c1c;line-height:1.6;">
                  Your account may be compromised. Immediately review and revoke any suspicious sessions.
                </p>
                <div style="margin-top:16px;text-align:center;">
                  <a href="${clientUrl}/settings#sessions"
